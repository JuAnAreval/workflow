...
@Injectable()
export class ProjectWorkflowSchedulerService
  implements OnModuleInit, OnModuleDestroy
{
  private readonly logger = new Logger(ProjectWorkflowSchedulerService.name);
  ...
  private async evaluateScheduleNode(
    ...
    try {
      await this.projectWorkflowAutomationService.runScheduledWorkflowTrigger({
        workflowId,
