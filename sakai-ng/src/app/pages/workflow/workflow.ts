...
export class Workflow
  extends WorkflowExtractedEditorRuntimeMethodsBase
  implements AfterViewInit, AfterViewChecked, OnDestroy
{
  ...
  getConditionOperatorOptionsForField(
    ...
    const filtered = this.conditionOperatorOptions.filter((option) =>
      allowed.includes(option.value),
    );

    return filtered.length ? filtered : this.conditionOperatorOptions;
  }
